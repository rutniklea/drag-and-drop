...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    progressListArray = ['Work on projects', 'Adding a file to a repository'];
    completeListArray = ['Grocery Shopping', 'Email Follow-Up'];
    onHoldListArray = ['Home Cleaning', 'Listen to music'];
  }
}
